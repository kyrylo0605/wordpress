		...
		public function wip_custom_login_panel() {
			...
			foreach ( $this->panel_fields as $element) {
				...
				if (isset($element['type'])) :
                    ...
                    echo "<li class='".esc_attr($class)."''><a target='_blank' href='".esc_url( get_site_url() . '/wp-login.php')."'>".esc_html__( 'Login page preview','wip-custom-login')."</a></li>";

                    echo "<li class='".esc_attr($class)."''><a target='_blank' href='".esc_url( 'https://www.themeinprogress.com/c-login-free-custom-login-wordpress-plugin/?aff=panel')."'>".esc_html__( 'Upgrade to PRO','wip-custom-login')."</a></li>";
...
<p><?php echo esc_html($value['desc']); ?></p>
								...
								case 'import_export': ?>
									...
									<div class="WIP_custom_login_box">
									    ...
									    <label for="<?php echo esc_attr($value['id']); ?>"><?php _e( "Current plugin settings","wip-custom-login"); ?></label>
									...
									<div class="WIP_custom_login_box">
									    ...
									    <label for="<?php echo esc_attr($value['id']); ?>"><?php _e( "Reset plugin settings","wip-custom-login"); ?></label>
									...
									<div class="WIP_custom_login_box">
									    ...
									    <label for="<?php echo esc_attr($value['id']); ?>"><?php _e( "Import plugin settings","wip-custom-login"); ?></label>
